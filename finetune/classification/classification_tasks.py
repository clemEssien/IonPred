...
class FE2(ClassificationTask):
    """FE2."""

    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(FE2, self).__init__(config, "FE2", tokenizer, ["0", "1"])
...
class FE3(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(FE3, self).__init__(config, "FE3", tokenizer, ["0", "1"])
...
class ZN(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(ZN, self).__init__(config, "ZN", tokenizer, ["0", "1"])
...
class CA(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CA, self).__init__(config, "CA", tokenizer, ["0", "1"])
...
class MG(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(MG, self).__init__(config, "MG", tokenizer, ["0", "1"])
...
class MN(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(MN, self).__init__(config, "MN", tokenizer, ["0", "1"])
...
class CU(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CU, self).__init__(config, "CU", tokenizer, ["0", "1"])
...
class CO(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CO, self).__init__(config, "CO", tokenizer, ["0", "1"])
...
class K(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(K, self).__init__(config, "K", tokenizer, ["0", "1"])
...
class NA(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(NA, self).__init__(config, "NA", tokenizer, ["0", "1"])
...
class CD(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CD, self).__init__(config, "CD", tokenizer, ["0", "1"])
...
class NI(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(NI, self).__init__(config, "NI", tokenizer, ["0", "1"])
...
class PO4(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(PO4, self).__init__(config, "PO4", tokenizer, ["0", "1"])
...
class CO3(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CO3, self).__init__(config, "CO3", tokenizer, ["0", "1"])
...
class CO2(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CO2, self).__init__(config, "CO2", tokenizer, ["0", "1"])
...
class SO4(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(SO4, self).__init__(config, "SO4", tokenizer, ["0", "1"])
...
class I(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(I, self).__init__(config, "I", tokenizer, ["0", "1"])
...
class CL(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(CL, self).__init__(config, "CL", tokenizer, ["0", "1"])
...
class BR(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(BR, self).__init__(config, "BR", tokenizer, ["0", "1"])
...
class F(ClassificationTask):
    ...
    def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
        super(F, self).__init__(config, "F", tokenizer, ["0", "1"])
